...
ONNX_MODEL = './yolo_world_v2.onnx'
RKNN_MODEL = './yolo_world_v2.rknn'
...
def export_rknn_inference(img):
    ...
    # ret = rknn.load_onnx(model=ONNX_MODEL, outputs=['onnx::Concat_1182', 'onnx::Reshape_1191', 'onnx::Concat_1251', 'onnx::Reshape_1260', 'onnx::Concat_1320', 'onnx::Reshape_1329'])
    if ret != 0:
